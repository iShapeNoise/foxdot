...
class Editor(App):
    ...
    #     self.config = {
    #         'font': FONT,
    #         'menu_on_startup': MENU_ON_STARTUP,
    #         'console_on_startup': CONSOLE_ON_STARTUP,
    #         'linenumbers_on_startup': LINENUMBERS_ON_STARTUP,
    #         'treeview_on_startup': TREEVIEW_ON_STARTUP,
    #         'midibar_on_startup': MIDIBAR_ON_STARTUP,
    #         'use_alpha': USE_ALPHA,
    #         'alpha_value': ALPHA_VALUE,
    #         'auto_complete_brackets': AUTO_COMPLETE_BRACKETS,
    #         'cpu_usage': CPU_USAGE
    #     }
    #
    #     # Load theme configuratio    #     show_console = reactive(True)
    #     show_treeview = reactive(True)
    #     show_linenumbers = reactive(True)
    #
    # def watch_show_console(self, show: bool) -> None:
    #     self.query_one("#console").display = shown
    ...
    #                     self.theme_colors = item[COLOR_THEME]["colors"]
    #                     break
    #     except FileNotFoundError:
    #         # Use default colors if theme file not found
    #         self.theme_colors = {
    #             'fg': '#ffffff',
    #             'bg': '#1a1a1a',
    #             'secondary': '#bf4acc',
    ...
    #     """Initialize reactive component visibility states"""
    #     self.show_menu = self.config['menu_on_startup']
    #     self.show_console = self.config['console_on_startup']
    #     self.show_linenumbers = self.config['linenumbers_on_startup']
    #     self.show_treeview = self.config['treeview_on_startup']
    #     self.show_midibar = self.config['midibar_on_startup']
...
#         self.root.grid_columnconfigure(2, weight=1)  # Scrollbar
...
#         self.text.bind("<Escape>"    #     show_console = reactive(True)
    #     show_treeview = reactive(True)
    #     show_linenumbers = reactive(True)
    #
    # def watch_show_console(self, show: bool) -> None:
    #     self.query_one("#console").display = show, self.toggle_true_fullscreen)
...
#         # Fixes a MacOS tilde bug.
#         self.text.bind("<Alt-n>", lambda event: "break")
...
#         OSCVG.set_code_text(self.text.get(a, b))
#         try:
...
#         """
#         Sets the text and console background to black and then removes
#         all black pixels from the GUI
#         """
...
#         """
#         Creates thread to wait 0.2 seconds before removing any highlights
#         from the text
#         """
#         # Remove labels
...
#         """
#         Called using Ctrl+D - duplicates the content of this line and moves the
#         insert to the same place on the line below
#         """
...
#         """
#         Goes through the whole text and adds multiline formatting where
...
#         """
#         Given two Tkinter indices, will select non-selected text in the range
#         and de-select the selected text
#         """

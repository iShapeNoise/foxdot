...
class SampleChart:
    ...
    def __init__(self):
        ...
        # Call init methods
        self.sp_count = len([name for name in os.listdir(str(FOXDOT_SND))])
        self.sp_names = os.listdir(str(FOXDOT_SND))
        self.sp_names.sort()
        self.sp_view()
        self.create_dics(spack_id="0")
    ...
    def create_dics(self, spack_id="0"):
        """
        ...
        self.sp_path_l = os.path.join(FOXDOT_SND, spack_id, "")
        self.dir_list_l = []
        ...
        # audio as values
        self.sp_path_s = os.path.join(FOXDOT_SND,
                                      str(spack_id),
                                      "_",
                                      "")
        self.dir_list_s = []
        ...
        self.sp_path_loops = os.path.join(FOXDOT_SND,
                                          spack_id,
                                          FOXDOT_LOOP,
                                          "")
        self.smpl_list = [

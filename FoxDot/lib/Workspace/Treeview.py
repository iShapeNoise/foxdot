...
from ..Settings import FOXDOT_EDITOR_ROOT


class TreeView(ScrollView):
    """File explorer tree view with vertical scrollbar"""
    ...
    def on_directory_tree_file_selected(self, event):
        """Handle file selection - open .py files"""
        if event.path.suffix == ".py":
            self.app.open_file(event.path)

...
def arrow_zip(pat1, pat2):
    """
    Zips two patterns together. If one item is a tuple,
    it extends the tuple / PGroup
...
def feed(string):
    """
    Used to recursively parse nested strings, returns a list object
    (not Pattern), and a boolean denoting if the list contains a nested list
    """
